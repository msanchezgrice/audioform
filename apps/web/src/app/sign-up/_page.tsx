...
export default function SignUpPage() {
  ...
  return <AuthPage eyebrow="Account" title="Create a free account" description="Create a workspace to manage your projects and integrations. No card required.">
    {configured ? <><SignupFlowTracker /><SignUp appearance={authAppearance} fallbackRedirectUrl="/dashboard" routing="path" path="/sign-up" signInUrl="/sign-in" /></> : <AuthFallback><p>Self-serve signup is not active yet. Email <a href="mailto:support@talkform.ai">support@talkform.ai</a> for help getting started.</p></AuthFallback>}
    <AuthMachineNote />
  </AuthPage>;
}
