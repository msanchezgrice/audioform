...
export default function SignUpPage() {
  ...
  return <main className={styles.page}>
    ...
    {configured ? <><SignupFlowTracker /><div className={styles.prose}><SignUp routing="path" path="/sign-up" signInUrl="/sign-in" /></div></> : <Prose><p>Self-serve signup is not active yet. Email <a href="mailto:support@talkform.ai">support@talkform.ai</a> to join the Pro pilot.</p></Prose>}
  </main>;
}
