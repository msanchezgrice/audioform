...
const faqs = [
  ...
  { question: "How much does Talkform cost?", answer: "Core text handoffs are free. Machine workspaces start with 10 handoffs per day; an optional signed-in human claim enables up to 100 per day per project. Respondent links and completed results stay available for 7 days. Voice is available under shared limits, and no payment or business email is required." },
