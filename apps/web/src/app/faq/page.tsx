...
const faqs = [
  ...
  { question: "How much does Talkform cost?", answer: "Talkform is free for up to 100 hosted text handoffs per day per project. Respondent links stay available for 7 days and completed results stay available for 7 days. Voice is optional under shared limits, and no payment or business email is required." },
